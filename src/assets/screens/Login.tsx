        ...
        <div className="w-full xl:w-1/2 p-8  flex flex-col xl:pl-0 xl:pr-10">
          ...
          <div className="flex mb-4 w-full">
            ...
            <div className="flex justify-end items-center text-sm w-1/2">
              <a href="#" className="text-greyDark hover:text-greyDark/50 transition duration-300">
                Lupa password?
              </a>
            </div>
          </div>
          ...
          <div className="mt-4 text-base flex justify-center">
            ...
            <a href="/register" className="text-primary hover:text-primary/50 transition duration-300" >
              Daftar
            </a>
          </div>
