    ...
    <div className="flex justify-center items-center min-h-screen bg-silver">
        <div className="bg-white rounded-md shadow-lg overflow-hidden w-11/12 lg:w-2/3">
            ...
            <div className="p-5 flex flex-col xl:px-10">
                ...
                <p className="font-extralight text-lg xl:text-xl text-center mb-8">e-UMKM</p>
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-3">
                    ...
                    <div className='px-4'>
                        ...
                        <button className="w-full py-2 bg-primary text-white rounded-md font-semibold md:font-bold mt-4 ">
                            Daftar
                        </button>
                    </div>

                    <div className="mt-0 text-sm flex justify-start items-center mb-0 py-0 ml-5">
