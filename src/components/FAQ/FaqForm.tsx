      ...
      <form className="" onSubmit={handleSubmit}>
        ...
        >
          ...
          <label
            ...
            className="peer-focus:font-medium absolute text-sm  text-grey duration-300 transform -translate-y-6 scale-75 top-3 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 z-10"
          >
        ...
        >
          <textarea
            name="question"
            id="floating_area"
            className="block py-2.5 px-0 w-full text-sm -grey bg-transparent rounded order-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-primary peer"
            placeholder=" "
