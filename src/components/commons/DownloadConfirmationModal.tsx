  ...
  return (
    <div>
      <div
        id="timeline-modal"
        aria-hidden="true"
        className="overflow-y-auto overflow-x-hidden flex bg-black/25 fixed top-0 right-0 left-0 z-[60] justify-center items-center w-full md:inset-0 h-screen transition duration-500"
      >
