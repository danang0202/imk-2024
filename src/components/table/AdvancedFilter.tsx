  ...
  return (
    <>
      <motion.div
        ...
        className="fixed xl:relative z-40 flex flex-col bg-white rounded-e-sm xl:rounded-sm p-6 shadow-lg xl:shadow-none dark:bg-black max-h-[80vh] overflow-y-scroll xl:max-h-fit xl:overflow-y-hidden border border-gray-300 xl:border-none xl:max-w-[16rem]"
      >
