...
const SearchBar: React.FC<Props> = ({
  ...
  const columns: titleSlugType[] = dataColumnProdukBuilder;
  ...
  const handleKeywordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setKeyword(value);
    const dataFix = data ? data : produkData;
