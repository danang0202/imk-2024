  ...
  return (
    <form className="">
      <select
        ...
        className="whitespace-nowrap bg-gray-50 border border-gray-300 text-gray-900 text-xs md:text-sm xl:text-base rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 cursor-pointer dark:bg-slate-800 dark:border-gray-600 dark:text-white"
      >
